...
public class PostgreSqlDialect implements DbDialect {
    ...
    public String buildJdbcUrl(String host, Integer port, String databaseName, Map<String, String> params) {
        ...
        String db = (databaseName != null && !databaseName.isBlank()) ? databaseName.trim() : "postgres";

        String sslMode = (params != null) ? params.getOrDefault("sslmode", "prefer") : "prefer";
        return "jdbc:postgresql://" + h + ":" + p + "/" + db + "?sslmode=" + sslMode;
    }
