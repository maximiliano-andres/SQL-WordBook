...
public class MySqlDialect implements DbDialect {
    ...
    public String buildJdbcUrl(String host, Integer port, String databaseName, Map<String, String> params) {
        ...
        String db = (databaseName != null && !databaseName.isBlank()) ? databaseName.trim() : "mysql";

        return "jdbc:mysql://" + h + ":" + p + "/" + db + "?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC&characterEncoding=UTF-8";
    }
